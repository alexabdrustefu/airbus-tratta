...
public class CustomAribusRepositoryImpl implements CustomAribusRepository {
	@PersistenceContext
	...
	public List<Airbus> findByExample(Airbus example) {
		...
		if (example.getNumeroPassegeri() != null) {
			whereClauses.add(" a.numeroPassegeri =:numeroPassegeri");
			paramaterMap.put("numeroPassegeri", example.getNumeroPassegeri());
		}
